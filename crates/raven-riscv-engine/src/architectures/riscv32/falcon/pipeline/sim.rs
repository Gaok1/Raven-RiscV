#![allow(clippy::collapsible_if, clippy::manual_range_patterns, clippy::question_mark, clippy::too_many_arguments, clippy::type_complexity, clippy::unnecessary_map_or)]
