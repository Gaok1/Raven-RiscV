...
pub struct ElfInfo {
    ...
    /// First address past all loaded segments â€” use as initial heap break.
    pub heap_start: u32,
    /// Symbol table: addr â†’ list of names (STT_FUNC / STT_OBJECT, non-empty, non-`$`-prefixed).
...
pub fn load_elf<B: Bus>(bytes: &[u8], mem: &mut B) -> Result<ElfInfo, FalconError> {
    // â”€â”€ magic / class / data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if bytes.len() < 52 {
    ...
    // â”€â”€ iterate PT_LOAD segments â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const PT_LOAD: u32 = 1;
    const PF_X: u32 = 1;
    ...
    // â”€â”€ Parse section headers (best-effort, non-fatal) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
fn parse_sections(
    ...
    // â”€â”€ Read all section headers into a lightweight cache â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    struct Shdr {
        name_off: u32,
        sh_type: u32,
        addr: u32,
    ...
    // â”€â”€ Locate shstrtab (section name string table) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Find .symtab section â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const SHT_SYMTAB: u32 = 2;
    const SHT_STRTAB: u32 = 3;
    const STT_NOTYPE: u8 = 0; // plain assembly labels â€” no type annotation
    ...
    // â”€â”€ Collect data/rodata/bss sections for the viewer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    for sh in &shdrs {
