// falcon/decoder/fptype.rs â€” RV32F decoder
use super::{bits, sext};
use crate::falcon::{errors::FalconError, instruction::Instruction};

/// Decode OPC_FP (0x53) â€” all FP arithmetic, comparison, conversion, and move instructions
...
/// Decode OPC_FLW (0x07) â€” I-type float load
...
/// Decode OPC_FSW (0x27) â€” S-type float store
