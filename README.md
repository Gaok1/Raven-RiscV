...
A working example with `_start`, panic handler, and ready-to-use wrappers for `write`/`exit` is available at [`docs/RustCompatibleABI.rs`](docs/RustCompatibleABI.rs).
