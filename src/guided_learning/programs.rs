// Embedded guided-activity programs (.fas source text).
...
pub(super) const D101: &str = include_str!("../../guided-activity/programas/D101.fas");
pub(super) const D102: &str = include_str!("../../guided-activity/programas/D102.fas");
