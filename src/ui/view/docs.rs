...
fn render_instr_ref(f: &mut Frame, area: Rect, app: &App) {
    ...
    let chunks = Layout::default()
        ...
        .constraints([
            Constraint::Length(2),            // page tab bar (new)
...
fn raw(s: &'static str) -> Line<'static> {
    Line::raw(s)
}
...
fn syscall_lines_en() -> Vec<Line<'static>> {
    vec![
        ...
        trow("94", "exit_group", "code=a0", "—", "same as exit (93)"),
        trow(
            "278",
            "getrandom",
        ...
        trow(
            ...
            "—",
            "a0=count",
            "alias of 1030; cycle-accurate may differ in future",
        ),
        trow(
            "1100",
            "hart_start",
...
fn syscall_lines_ptbr() -> Vec<Line<'static>> {
    vec![
        ...
        trow("94", "exit_group", "code=a0", "—", "igual a exit (93)"),
        trow(
            "278",
            "getrandom",
            "buf=a0, len=a1, flags=a2",
        ...
        trow(
            ...
            "—",
            "a0=count",
            "alias de 1030; pode diferir em versão futura",
        ),
        trow(
            "1100",
            "hart_start",
