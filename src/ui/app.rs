...
pub(super) struct CacheState {
    ...
    pub(super) view_hscroll_drag: bool,
    pub(super) view_hscroll_drag_track_x: u16,
    pub(super) view_hscroll_drag_track_width: u16,
    pub(super) view_hscroll_drag_max_h_scroll: usize,
    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            cache: CacheState {
                ...
                view_scroll: 0,
                view_h_scroll: 0,
                view_hscroll_drag: false,
                view_hscroll_drag_track_x: 0,
                view_hscroll_drag_track_width: 0,
                view_hscroll_drag_max_h_scroll: 0,
                hover_reset: false,
                hover_pause: false,
                hover_scope_i: false,
                hover_scope_d: false,
