...
/// Row index of the vm_enabled (Sv32 + TLB) selector.
pub(crate) const SETTINGS_ROW_VM_ENABLED: usize = 5;
/// Row index of the tlb_enabled toggle (cache the page-table walks or not).
pub(crate) const SETTINGS_ROW_TLB_ENABLED: usize = 6;
...
pub(crate) struct SettingsState {
    ...
    /// Mouse hover over the tlb_enabled bool button
    pub(crate) hover_tlb_enabled: bool,
    ...
    /// Geometry of the tlb_enabled bool button (y, x_start, x_end)
    pub(crate) bool_btn_tlb_rect: std::cell::Cell<(u16, u16, u16)>,
